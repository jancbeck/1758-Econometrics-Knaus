...
Histogram: Looking at the histogram, it does not look like a symmetric distribution around 0. It seems that the residuals are not normally distributed, as they are located around 1.5 and not around 0. And they have outliers on both sides which they do ot have not the other side. 
...
H0: $\beta_2= 0$
H1: $\beta_2\neq0$
We can use a t-test, to test if we should include quadratic part of the function or not. If $\beta_0\neq0$ non-linearity is given in our model and we should not exclude the quaratic term. 
